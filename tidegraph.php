	...
	function form( $instance ) {
		...
		<table>
			...
			<tr>
				...
				<td>
					<input style="width:40px" id="<?php echo $this->get_field_id( 'scale' ); ?>" name="<?php echo $this->get_field_name( 'scale' ); ?>" value="<?php echo $instance['scale']; ?>" style="width:100%;" />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<input style="width:100px" id="<?php echo $this->get_field_id( 'latitude' ); ?>" name="<?php echo $this->get_field_name( 'latitude' ); ?>" value="<?php echo $instance['latitude']; ?>" style="width:100%;" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input style="width:100px" id="<?php echo $this->get_field_id( 'longitude' ); ?>" name="<?php echo $this->get_field_name( 'longitude' ); ?>" value="<?php echo $instance['longitude']; ?>" style="width:100%;" />
				</td>
			</tr>
		</table>
